...
function searchBook() {
    ...
    books.forEach(book => {
        if (select === 'all' && (
                ...
                (book.categories || []).some(cat => cat.toLowerCase().includes(input))
            )) {
            displayBook(book);
            found = true;
            ...
            displayBook(book);
            found = true;
        } else if (select === 'categorie' && (book.categories || []).some(cat => cat.toLowerCase().includes(input))) {
            displayBook(book);
            found = true;
        }
    });
    ...
    bookDetail.innerHTML = ` 
            ...
            <div class="textDetail">
                ...
                <div class="buttonDetail">
                    ...
                    <a href="" onclick='addToWishList(this)' dataBook='${JSON.stringify(book)}' >${wishButton}</a>    
                </div>
            </div>`;
